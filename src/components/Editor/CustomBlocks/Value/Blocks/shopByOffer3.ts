...
const shopByOffer3Block = (editor: Editor) => {
  const options = {
    id: "value-shopByOffer3",
    label: "Shop By Offer 3",
    block: {},
    props: {},
    style: "",
    category: "Value",
    classPrefix: "value-shopByOffer3",
    styleAdditional: "",
...
const shopByOffer3Component = (editor: Editor) => {
  const options = {
    id: "value-shopByOffer3",
    label: "Shop By Offer 3",
    block: {},
...
export { shopByOffer3Block, shopByOffer3Component };
