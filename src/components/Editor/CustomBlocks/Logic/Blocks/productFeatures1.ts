...
const productFeatures1Block = (editor: Editor) => {
  const options = {
    id: "logic-productFeatures1",
    label: "Product Features 1",
    block: {},
    props: {},
    style: "",
    category: "Logic",
    classPrefix: "logic-productFeatures1",
    styleAdditional: "",
...
const productFeatures1Component = (editor: Editor) => {
  const options = {
    id: "logic-productFeatures1",
    label: "Product Features 1",
    block: {},
...
export { productFeatures1Block, productFeatures1Component };
