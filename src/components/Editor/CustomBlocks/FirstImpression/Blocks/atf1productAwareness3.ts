...
const options = {
  id: "firstImpression-atf1-product-awareness3",
  label: "ATF1 Product Awareness3",
  block: {},
  props: {},
  style: "",
  category: "First Impression",
  classPrefix: "firstImpression-atf1-product-awareness3",
  styleAdditional: "",
...
const atf1ProductAwareness3block = (editor: Editor) => {
  // create a block
...
const atf1ProductAwareness3Component = (editor: Editor) => {
...
export { atf1ProductAwareness3block, atf1ProductAwareness3Component };
