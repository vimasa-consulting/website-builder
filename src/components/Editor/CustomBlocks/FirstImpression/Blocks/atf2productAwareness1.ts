...
const options = {
  ...
  classPrefix: "firstImpression-atf2-product-awareness1",
  styleAdditional: "",
...
const atf2ProductAwareness1block = (editor: Editor) => {
  // create a block
...
const atf2ProductAwareness1Component = (editor: Editor) => {
...
export { atf2ProductAwareness1block, atf2ProductAwareness1Component };
