...
const options = {
  id: "firstImpression-atf2-conversion2",
  label: "ATF2 Conversion2",
  block: {},
  props: {},
  style: "",
  category: "First Impression",
  classPrefix: "firstImpression-atf2-conversion2",
  styleAdditional: "",
...
const atf2Conversion2block = (editor: Editor) => {
  // create a block
...
const atf2Conversion2Component = (editor: Editor) => {
...
export { atf2Conversion2block, atf2Conversion2Component };
