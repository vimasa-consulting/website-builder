...
const options = {
  id: "firstImpression-atf1-brand-connect1",
  label: "ATF1 BrandConnect1",
  block: {},
  props: {},
  style: "",
  category: "First Impression",
  classPrefix: "firstImpression-atf1-brand-connect1",
  styleAdditional: "",
...
const atf1BrandConnect1block = (editor: Editor) => {
  // create a block
...
const atf1BrandConnect1Component = (editor: Editor) => {
...
export { atf1BrandConnect1block, atf1BrandConnect1Component };
