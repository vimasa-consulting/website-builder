...
const options = {
  id: "firstImpression-atf1-conversion3",
  label: "ATF1 Conversion3",
  block: {},
  props: {},
  style: "",
  category: "First Impression",
  classPrefix: "firstImpression-atf1-conversion3",
  styleAdditional: "",
...
const atf1Conversion3block = (editor: Editor) => {
  // create a block
...
const atf1Conversion3Component = (editor: Editor) => {
...
export { atf1Conversion3block, atf1Conversion3Component };
