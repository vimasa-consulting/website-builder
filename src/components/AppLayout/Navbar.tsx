...
export default function Navbar() {
  ...
  return (
    <FlowbiteNavbar
      fluid={true}
      rounded={false}
      className="bg-black m-2 navbarBackground"
    >
      ...
      <Avatar className="cursor-pointer" onClick={openProfilePopup} alt="User settings" img="https://flowbite.com/docs/images/people/profile-picture-5.jpg" rounded />
