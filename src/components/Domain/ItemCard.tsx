...
export default function DomainItemCard({ item, setTableData }: Props) {
  ...
  return (
    <div className="max-w-xs mr-[32px]">
      <div
        onClick={openDomainSettingsHandler}
        className="w-[286px] h-[166px] bg-gray-300 border-none flex flex-col justify-center rounded-[10px] p-[40px] text-black gap-[10px] cursor-pointer"
      >
